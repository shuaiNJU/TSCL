...
class IMBALANCECIFAR10(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, train, transform, imbalance_ratio=0.01, root='/ssd1/haotao/datasets', imb_type='exp'):
        ...
        # train Mode: Contain 12406 images
    ...
    def get_img_num_per_cls(self, cls_num, imb_type, imb_factor):  #(10, 'exp', 0.01)
        img_max = len(self.data) / cls_num  #5000
        img_num_per_cls = []
        if imb_type == 'exp':
        ...
        return img_num_per_cls  # eg,  img_num_per_cls= [5000, 2997, 1796, 1077, 645, 387, 232, 139, 83, 50]

    def gen_imbalanced_data(self, img_num_per_cls):
        new_data = []
        new_targets = []
        targets_np = np.array(self.targets, dtype=np.int64)  # targets_np应该是5000个样本的label
